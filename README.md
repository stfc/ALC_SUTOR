...
```
cd existing_repo
git remote add origin https://gitlab.stfc.ac.uk/petrevisanutto/alc_scat.git
git branch -M main
...
- [x] [Set up project integrations](https://gitlab.stfc.ac.uk/petrevisanutto/alc_scat/-/settings/integrations)
